...
async function validateProfileContract(source, manifest) {
  const required = [
    ...
    ...Object.values(manifest.enforcement ?? {}),
  ];
  ...
  const evidenceKeys = new Set(["classification", "sourceId"]);
