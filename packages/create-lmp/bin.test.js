...
const bootstrapper = join(packageRoot, "bin.js");

function runBootstrapper(workspace, strategy, extraEnv = {}, agent = "cursor") {
  return new Promise((resolve, reject) => {
    const child = spawn(
      process.execPath,
      [bootstrapper, "--yes", "--agent", agent, "--mind", "tj-ponytail", "--stack", "typescript-node", "--strategy", strategy, workspace],
