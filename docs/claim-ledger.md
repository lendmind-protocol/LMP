...
| CL-011 | Cross-platform release artifacts are built and smoke-tested | `README.md`, release workflow | `.github/workflows/release.yml`, `.github/workflows/cross-platform-qualification.yml` | hosted matrix and archive gate | qualification run 34700933633 | PARTIAL | Linux x86_64, macOS arm64, and Windows x86_64 passed; macOS x86_64 remains queued and a tagged public release has not been published |
