...
| CL-011 | Cross-platform release artifacts are built and smoke-tested | `README.md`, release workflow | `.github/workflows/release.yml` | archive gate | release artifacts | PARTIAL | Matrix configuration is not evidence that every target ran |
