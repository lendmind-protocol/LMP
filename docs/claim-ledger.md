...
| CL-006 | MCP server implements a bounded JSON-RPC tool surface | `README.md` | `crates/lmp-mcp/` | MCP protocol tests plus official conformance smoke scenarios | MCP test output and CI conformance job | PARTIAL | Official conformance covers initialize, ping, tools/list, completion, resources/list, and prompts/list; optional capability suites and all-host interoperability remain unproven |
