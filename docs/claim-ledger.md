...
[`evidence/hosted-qualification-34733571572.md`](evidence/hosted-qualification-34733571572.md)
and hosted benchmark run
[34733571572](https://github.com/lendmind-protocol/LMP/actions/runs/34733571572)
for commit `03cfcae6701b62333f2ff9d116d39fad96500e0f`.
...
| CL-008 | LMP produces reproducible paired quality evidence against an ordinary-control baseline | `README.md`, `docs/Concept.md` | benchmark comparison harness | real-world benchmark | [hosted benchmark run 34737607974](https://github.com/lendmind-protocol/LMP/actions/runs/34737607974) and [revision-bound record](evidence/hosted-qualification-34737607974.md) | VERIFIED | This verifies the measurement protocol and supplied trials; it does not prove causal improvement across models, hosts, repositories, or reviewers |
