...
[`evidence/hosted-qualification-34745412764.md`](evidence/hosted-qualification-34745412764.md)
and hosted benchmark run
[34745412764](https://github.com/lendmind-protocol/LMP/actions/runs/34745412764)
for commit `452b8d414a260f9cacfcd9a023befd7b969843df`.
...
| CL-008 | LMP produces reproducible paired quality evidence against an ordinary-control baseline | `README.md`, `docs/Concept.md` | benchmark comparison harness | real-world benchmark | [hosted benchmark run 34745412764](https://github.com/lendmind-protocol/LMP/actions/runs/34745412764) and [revision-bound record](evidence/hosted-qualification-34745412764.md) | VERIFIED | This verifies the measurement protocol and supplied trials; it does not prove causal improvement across models, hosts, repositories, or reviewers |
