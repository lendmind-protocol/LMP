...
| CL-008 | LMP produces reproducible paired quality evidence against an ordinary-control baseline | `README.md`, `docs/Concept.md` | benchmark comparison harness | real-world benchmark | [hosted benchmark run 34733571572](https://github.com/lendmind-protocol/LMP/actions/runs/34733571572) | VERIFIED | This verifies the measurement protocol and supplied trials; it does not prove causal improvement across models, hosts, repositories, or reviewers |
