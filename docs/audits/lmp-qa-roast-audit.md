...
4. The official MCP conformance harness now covers initialization, ping,
   tool-discovery, completion, resource-listing, and prompt-listing scenarios
   in CI; optional capability suites and cross-host acceptance remain
   unverified.
