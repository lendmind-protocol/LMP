...
const expectedFixturesByProfile = new Map([
  ["profiles/baseline", new Map([["baseline-clean", null], ["baseline-finding", "typescript.any"], ["baseline-unsupported", null]])],
  ["profiles/typescript-minimal", new Map([["typescript-clean", null], ["typescript-any-eval", "typescript.eval"], ["typescript-command-denied", null]])],
